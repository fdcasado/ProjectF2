...
namespace ProjectF2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> EditarLojista([Bind(Include = "LojistaId,UserId,RazaoSocial,NomeFantasia,Email,Telefone,Senha,ConfirmacaoSenha,CNPJ")] Lojista lojista)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        private async Task<ActionResult> Register(RegisterViewModel model, string roleName)
        {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (User.IsInRole("Usuario")) controlerName = "Usuario";
                if (User.IsInRole("Lojista")) controlerName = "Lojista";

                return RedirectToAction("Index", controlerName, new { Message = "ChangePasswordSuccess" });
            }
